...
def test_get_status():
    ...
    pv.get_status(pv_system_id=10033, date=datetime(2022, 3, 1, 12), use_data_service=True, timezone='Europe/London')
...
def test_multiple_get_status():
    ...
    status_df = pv.get_system_status(
        pv_system_ids=[10033, 10020], date=datetime(2022, 3, 15), use_data_service=True, timezone='Europe/London'
    )
